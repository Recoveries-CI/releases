...
export ROM="TWRP"
export ROM_DIR="/home/faoliveira/twrp_un"
export local_manifest_url="https://raw.githubusercontent.com/faoliveira78/manifests/master/twrp/cheesedump.xml"
...
export release_branch="twrp-op5_t"
